...
function DashboardOverlay() {
    ...
    return (
        <div className="absolute top-4 left-4 z-50 flex flex-col items-end gap-2" style={{cursor: 'pointer'}}>
            {/* Toolbar pill */}
            <div className="flex items-center justify-between bg-white bg-opacity-80 backdrop-blur-md rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:bg-opacity-90">
