...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.deskGroup.add(this.add.image(2100, 420, 'desk').setScale(0.18).setDepth(420).refreshBody()); //%% desk
        // %% desk - rangée 2
        this.deskGroup.add(this.add.image(2100, 580, 'desk').setScale(0.22).setDepth(580).refreshBody()); //%% desk
        // %% desk - rangée 3
        this.deskGroup.add(this.add.image(2100, 740, 'desk').setScale(0.26).setDepth(740).refreshBody()); //%% desk
        // %% desk - rangée 4
        this.deskGroup.add(this.add.image(2100, 900, 'desk').setScale(0.30).setDepth(900).refreshBody()); //%% desk
        // %% desk - rangée 5 (la plus en avant, grande)
        this.deskGroup.add(this.add.image(2100, 1060, 'desk').setScale(0.34).setDepth(1060).refreshBody()); //%% desk
